/*  $Id: icode.c,v 1.1.1.1 2002/11/23 07:57:08 annihilator Exp $
...
void
i_generate_forward_branch (char b)
{
  end_pushes ();
  ins_byte (b);
...
void
i_update_forward_branch_links (char kind, parse_node_t * link_start)
{
  int i;
