/*  $Id: interpret.c,v 1.2 2002/11/25 11:11:05 annihilator Exp $
...
#include "_lpc/class.h"
#include "rc.h"
#include "backend.h"
#include "simul_efun.h"
#include "_efuns/operator.h"
#include "_efuns/sprintf.h"
#include "simulate.h"
#include "interpret.h"
#include "stralloc.h"
#include "comm.h"
...
#include "_efuns/.prototype.h"
#include "_efuns/.vector.h"
...
{
  /* 若 control stack 深度超過允許的上限, 視為錯誤 */
...
{
  /* 如果 control stack 深度超過允許的上限, 視為錯誤 */
  if (csp == &control_stack[CONFIG_INT (__MAX_CALL_DEPTH__) - 1])
    {
      error_state |= ES_STACK_FULL;
      error (_("***Too deep recursion."));
