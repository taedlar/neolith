...
#define __RESOLVER_FORWARD_CACHE_TTL__	CFG_INT(24)
#define __RESOLVER_REVERSE_CACHE_TTL__	CFG_INT(25)
#define __RESOLVER_NEGATIVE_CACHE_TTL__	CFG_INT(26)
#define __RESOLVER_STALE_REFRESH_WINDOW__ CFG_INT(27)
#define __RESOLVER_FORWARD_QUOTA__	CFG_INT(28)
#define __RESOLVER_REVERSE_QUOTA__	CFG_INT(29)
#define __RESOLVER_REFRESH_QUOTA__	CFG_INT(30)

#define RUNTIME_CONFIG_NEXT	CFG_INT(54)
