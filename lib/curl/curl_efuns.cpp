...
void init_curl_subsystem(void) {
  ...
  s_task_queue = async_queue_create(CURL_QUEUE_SIZE, sizeof(curl_task_t), ASYNC_QUEUE_BLOCK_WRITER);
  s_result_queue = async_queue_create(CURL_QUEUE_SIZE, sizeof(curl_completion_t), ASYNC_QUEUE_BLOCK_WRITER);
