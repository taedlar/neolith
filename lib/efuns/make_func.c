...
/*  $Id: make_func.y,v 1.1.1.1 2002/11/23 07:57:08 annihilator Exp $
...
{
       0,    88,    88,    88,    90,    90,    92,    94,    94,    96,
     112,   112,   114,   115,   121,   128,   206,   206,   208,   226,
     227,   228,   230,   238,   248,   249,   250
};
#endif
...
#line 1411 "make_func.c"
    break;

  case 11:
#line 112 "make_func.y"
                              { (yyval.string) = ""; }
#line 1417 "make_func.c"
    break;

  case 12:
#line 114 "make_func.y"
                              { (yyval.string)="DEFAULT_NONE"; }
#line 1423 "make_func.c"
    break;

  case 13:
#line 116 "make_func.y"
                  {
		      static char buf[40];
                      sprintf(buf, "%i", (yyvsp[0].number));
                      (yyval.string) = buf;
		  }
#line 1433 "make_func.c"
    break;

  case 14:
#line 122 "make_func.y"
                  { 
                      if (strcmp((yyvsp[0].string), "F_THIS_OBJECT"))
                          yyerror("Illegal default");
                      (yyval.string) = "DEFAULT_THIS_OBJECT";
                  }
#line 1443 "make_func.c"
    break;

  case 15:
#line 129 "make_func.y"
    {
	char buff[500];
	char f_name[500];
	int i, len;
...
#line 1580 "make_func.c"
    break;

  case 23:
#line 239 "make_func.y"
    {
...
#line 1593 "make_func.c"
    break;

  case 24:
#line 248 "make_func.y"
                                { (yyval.number) = ((yyvsp[0].number) == VOID && min_arg == -1); }
#line 1599 "make_func.c"
    break;

  case 25:
#line 249 "make_func.y"
                                { (yyval.number) = (min_arg == -1 && ((yyvsp[-2].number) || (yyvsp[0].number) == VOID));}
#line 1605 "make_func.c"
    break;

  case 26:
#line 250 "make_func.y"
                                { (yyval.number) = min_arg == -1 ; limit_max = 1; }
#line 1611 "make_func.c"
    break;


#line 1615 "make_func.c"
