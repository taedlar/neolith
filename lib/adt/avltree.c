/*  $Id: avltree.c,v 1.1.1.1 2002/11/23 07:57:08 annihilator Exp $
...
static void
del (tree ** ppr_r, int *pi_balance, tree ** ppr_q, int (*pfi_uar) (void *),
     int *pi_uar_called)
{
...
static void
balanceL (tree ** ppr_p, int *pi_balance)
{
  tree *p1, *p2;
  int b1, b2;
...
static void
balanceR (tree ** ppr_p, int *pi_balance)
{
  tree *p1, *p2;
  int b1, b2;
...
int
tree_trav (tree ** ppr_tree, int (*pfi_uar) (void *))
{
  if (!*ppr_tree)
    return 1;
