...
## DESCRIPTION
parse_command() is a piffed up [sscanf()](sscanf.md) operating on word
basis. It works similar to [sscanf()](sscanf.md) in that it takes a
pattern and a variable set of destination arguments. It is
together with [sscanf()](sscanf.md) the only efun to use pass by
