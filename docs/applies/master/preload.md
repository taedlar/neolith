...
The variable *load_empty* is non-zero if the `-e` option was specified when starting up the driver.
It can be used as a signal to the mudlib to not load castles, etc.
