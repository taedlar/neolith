...
if(NOT TARGET c-ares::cares)
  ...
  if(PkgConfig_FOUND)
    ...
    if(TARGET PkgConfig::PC_CARES)
      ...
      if(DEFINED PC_CARES_INCLUDE_DIRS AND NOT "${PC_CARES_INCLUDE_DIRS}" STREQUAL "")
        target_include_directories(c-ares::cares INTERFACE "${PC_CARES_INCLUDE_DIRS}")
        set(CARES_INCLUDE_DIR "${PC_CARES_INCLUDE_DIRS}")
      elseif(DEFINED PC_CARES_INCLUDEDIR AND NOT "${PC_CARES_INCLUDEDIR}" STREQUAL "")
        target_include_directories(c-ares::cares INTERFACE "${PC_CARES_INCLUDEDIR}")
        set(CARES_INCLUDE_DIR "${PC_CARES_INCLUDEDIR}")
      endif()
      set(CARES_LIBRARIES c-ares::cares)
