...
- If an efun name may be shadowed by simul_efun, prefer dot-call or `efun::`.
- If code intent is portability to older LPC without dot-call, prefer `efun::`.
- In reviews, flag ambiguous standalone calls when explicit efun intent appears intended.
